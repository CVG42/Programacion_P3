...
export default class EagleController
{
  ...
  private isFacingRight: boolean = true;
	...
	private createAnimations()
	{
		this.sprite.anims.create({
			...
			frameRate:8,
      frames: [
        {key:'eagle', frame:"00_eagle-attack.png"},
        {key:'eagle', frame:"01_eagle-attack.png"},
        {key:'eagle', frame:"02_eagle-attack.png"},
        {key:'eagle', frame:"03_eagle-attack.png"}],
      repeat:-1 //infinite
		})
